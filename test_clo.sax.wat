(module
  ...
  (rec (type $5 (struct (field (ref 6)))) (type $6 (func (param (ref 5) i32) (result i32))))
  ...
  (func $9 (type 7) (ref.func 12) (struct.new 5) (return))
  (func $10
    (type 3)
    (local (ref 5) i32)
    (call 9)
  ...
  (func $11 (type 3) (call 10) (i32.const 1) (call 2) (i32.const 0) (i32.const 0) (call 0) (call 1) (i32.const 0))
