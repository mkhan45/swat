(module
  ...
  (func $8 (type 4) (local i32) (call 6) (local.set 0) (local.get 0) (return_call 7))
  (func $9 (type 8) (ref.func 12) (struct.new 10) (return))
  (func $10
    (type 4)
    (local (ref 10) i32)
    (call 9)
  ...
  (func $11 (type 4) (call 10) (i32.const 1) (call 2) (i32.const 0) (i32.const 0) (call 0) (call 1) (i32.const 0))
  (func $12 (type 7) (local i32 i32 i32) (call 6) (local.set 2) (local.get 1) (local.get 2) (return_call 5))
  (data $0
